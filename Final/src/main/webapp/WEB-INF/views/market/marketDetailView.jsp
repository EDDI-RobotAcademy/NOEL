	...
	<div class="content-wrap4"
						...
						<div class="modal-body mb-3">
							...
							<fieldset>
								<input type="hidden" name="userId"
									...
									name="prdNo" value="${prd.prdNo}"> <input type="hidden"
									name="prdName" value="${prd.prdName}"> <input
									type="hidden" name="marketerId" value="${prd.marketerId}">
								<input type="radio" name="rating" value="5" id="rate1" checked>
								<label for="rate1">♥</label> <input type="radio" name="rating"
					...
					<table class="qna-list">
						...
						<th width="15%">등록일</th>
	                              ...
	                              답변완료
										...
										<td width="15%"><c:out value="${qnalist.userId}" /></td>
						...
						<div class="w3-modal-content w3-card-4"
							...
							<div class="w3-container"
								...
								<form action="/market/qnaDetail" method="get" class="pwFrm">
									...
									<input type="hidden" name="prdQnano"
										value="${qnalist.prdQnano}"> <input
										class="w3-input w3-border w3-round-large" type="password"
										name="prdQnapw" style="width: 250px; margin-left: 10px;"><br>
									<button class="btn btn-brand"
										style="margin-left: 10px; color: white; float: right;"
										onclick="pwChk(this)">확인</button>
								</form>
							</div>
						</div>
					</div>
		...
		<div align="center">
			...
			<c:forEach begin="1" end="${qnapageNum}" var="qnum">
				<span> <a
					href="/marketDetailView?prdNo=${param.prdNo}&rnum=1&qnum=${qnum}#qna-wrap">
						${qnum} </a>
				</span>
			</c:forEach>
		</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body mb-3">
							<input type="hidden" name="userId"
								value="${sessionScope.m.userId}"> <input type="hidden"
								name="prdNo" value="${prd.prdNo}"> <input type="hidden"
								name="marketerId" value="${prd.marketerId}"> <label
								for="message-text" class="col-form-label">문의할 내용을
								작성해주세요.</label>
							<textarea name="prdQnacontent" class="chk2 form-control"
								id="message-text" style="height: 15em; resize: none;"
								autofocus="autofocus" title="문의할 내용을 작성해주세요."></textarea>
							<br>
							<div>
								<input class="checkbox" type="checkbox" name="secret"
									id="secret"> <label class="form-check-label">비밀글
								</label>
							</div>
							<div style="display: none; float: left;" class="secretPw">
								<input class="chk3 w3-input w3-border w3-round-large"
									id="prdQnapw" name="prdQnapw" type="text"
									style="width: 100px; margin: 0 auto;" placeholder=" 비밀번호"
									title="비밀번호를 입력해주세요.">
							</div>
						</div>
						<div class="modal-footer">
