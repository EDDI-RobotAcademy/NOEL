    ...
    <c:otherwise>
        <div class="noticeDetail-wrap">
            ...
            <div class="notice-detail-btn">
                <c:choose>
                    <c:when test="${not empty sessionScope.m and sessionScope.m.userLevel eq 2}">
                        ...
                        <button type="button" class="btn btn-secondary" style="margin-left: 10px;" onclick="goNoticeList()">목록으로</button>
                    </c:when>
