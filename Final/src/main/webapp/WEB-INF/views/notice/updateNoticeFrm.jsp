...
<body>
	...
	<div class="notice-write-wrap">
		...
		<div class="notice-write-frm">
			<form action="/updateNotice" id="noticeFrm" method="post"
				...
				<table class="notice-tbl">
					<tr
						...
						<td style="width: 700px;"><input
							...
							type="text" style="width: 630px; margin: 0 auto;"
					...
					<tr style="height: 400px;">
						...
						<td style="text-align: left;">
							<div class="form-floating"
								...
								<textarea class="form-control" name="noticeContent" id="summernote"
									style="height: 340px">
                                    ${n.noticeContent }
                                </textarea>
				...
				<div class="notice-write-btn">
					...
					<button type="button" class="btn-write" id="noticeWriteBtn"
						onclick="noticeWrite()">수정완료</button>
				</div>
			</form>
		</div>
	</div>
		...
		$("#file").on("change",	function() {
			...
			if (fileList.length > 5) {
				...
				for (let i = 0; i < fileList.length; i++) {
					...
					fileDiv.append("<span class=''>"+ fileList[i].name
