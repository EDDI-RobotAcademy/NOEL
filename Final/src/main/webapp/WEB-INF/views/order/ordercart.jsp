...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
	...
	<div class="page-content">
		...
		<form id="order-form" action="/orderNext.do" method="post"
			autocomplete="off">

			<div class="page-title order-title" id="font"><h5>주문정보</h5></div>
			<div class="order-info" id="font">
				...
				<div class="order-box">
					<label for="name" class="order-label">주문자명</label>
					 <input type="text" id="orderName" class="order-input medium" value="${sessionScope.m.userName }">
                        <input type="hidden" name="memberId" value="${sessionScope.m.userId }">
				</div>
				<div class="order-box">
			...
			<div class="page-title order-title"><h5>배송정보</h5></div>
			<div class="order-info shipping" id="font">
				<div id="same-check">
					<input type="checkbox" id="order-same" class="order-agree">
					<label for="order-same"><i class="fa-solid fa-check"></i></label> <label
						for="order-same">주문자와 동일</label>
				</div>
				<div class="order-box">
			...
			<div class="order-info" style="padding-top: 80px;">
				<div id="agree-box">
					...
					<label for="info-agree"><i class="fa-solid fa-check"></i></label> <label
						for="info-agree" id="font">주문 내용을 확인하였으며, 정보 제공 등에 동의합니다.</label>
				</div>
