	...
	<div class="page-content">
					...
					<tbody>
						...
						<tr class="showCartList" id="font">
							...
							<td class="pImg" style="text-align: center"><img
								src="resources/upload/product/${Order.prdthumNail }"></td>
		...
		<form id="order-form" action="/orderDirect" method="post"
			...
			<input type="hidden" id="cart-quantity-sum" name="orderQuan"
				value="${Order.cartQuan }"> <input type="hidden"
				id="cart-price-sum" name="orderPrice"
				value="${Order.prdPrice*Order.cartQuan }"> <input
				type="hidden" id="cart-price-sum" name="prdNo"
				value="${Order.prdNo }"> <br>
			<h4 id="font">배송정보</h4>
			<br>
			<div class="order-info shipping" id="font">
				...
				<div class="order-box">
					<label for="shippingPhone" class="order-label">전화번호</label> <input
						...
						placeholder="숫자만 입력해주세요" required> <input type="text"
