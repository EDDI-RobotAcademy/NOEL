									...
									<div class="cnt">
										<div class="input01">
											<input type="text" id="memberName" name="memberName"
												value="${sessionScope.o.ownerName }" disabled>
										</div>
									</div></li>
									...
									<div class="cnt">
										<div class="input01" id="input01">
											<input type="text" id="memberId" name="memberId"
												value="${sessionScope.o.ownerId }" disabled>
										</div>
									</div></li>
									...
									<div class="cnt">
										<div class="input02">
											<input type="text" id="memberPhone1" name="memberPhone1"
												value="${sessionScope.o.ownerPhone }" disabled>
										</div>
									</div></li>
								<li><span class="tit">가입일</span>
									<div class="cnt">
										<div class="input01">
											<input type="text" id="ownerEnrollDate"
												name="ownerEnrollDate"
												value="${sessionScope.o.ownerEnrollDate }" disabled>
										</div>
									</div></li>
									...
									<div class="cnt">
										<div class="input01">
											<input type="hidden" id="ownerStatus1" name="ownerStatus1"
												value="${sessionScope.o.ownerStatus }" disabled> <input
