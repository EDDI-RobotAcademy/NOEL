      ...
      <div class="card-body">
         ...
         <form id="addClass" method="post" action="/class/addClass" enctype="multipart/form-data">
            <div class="form-group">
               ...
               <br>
               <input type="text" class="form-control" id="marketerId" name="marketerId" 
            ...
            <div class="submitBtn">
            	<button type="submit" class="btn btn-brand2" id="font">저장</button>
               	<button type="button" onclick="javascript:history.go(-1);" class="btn btn-brand2">취소</button>
            </div>
         </form>
