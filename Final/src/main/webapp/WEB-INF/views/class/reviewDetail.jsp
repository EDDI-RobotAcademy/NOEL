...
<div class="review-detail-wrap">
   <form name="reviewupdateForm" role="form" method="post" action="/class/reviewUpdate">
      <input type="hidden" id="classReviewNo" name="classReviewNo" value="${reviewdetail.classReviewNo}"/>
      <input type="hidden" id="classNo" name="classNo" value="${reviewdetail.classNo}"/>
      <c:choose>
         <c:when test="${sessionScope.m.userId eq reviewdetail.userId}">
            <table>
               ...
               <tr height="80px">
                  ...
                  <td>
                      <textarea name="classReviewContent" class="form-control" id="message-text"
                                style="height:10em; width:500px; resize:none;" autofocus>${reviewdetail.classReviewContent}</textarea>
                  </td>
               </tr>
               </tbody>
            </table>
            ...
            <div class="reviewDetail_btn">
               ...
               <a href="/class/reviewDelete?classReviewNo=${reviewdetail.classReviewNo}&classNo=${reviewdetail.classNo}"
         ...
         <c:otherwise>
            <table>
               ...
               <tr height="80px">
                  ...
                  <td>
                              <textarea name="classReviewContent" class="form-control" id="message-text"
                                        style="height:10em; width:500px; resize:none;" readonly="readonly">${reviewdetail.classReviewContent}</textarea>
                  </td>
               </tr>
               </tbody>
            </table>
