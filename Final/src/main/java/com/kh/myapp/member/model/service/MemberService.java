...
public class MemberService {
	...
	public HashMap<String, Object> searchMarketer(String type, String keyword, int reqPage) {
		...
		String pageNavi = "";
		if(pageNo != 1) {
			pageNavi += "<a href='/searchMarketer?reqPage=" + (pageNo - 1) + "'><span class='material-symbols-outlined' style='font-size: 30px;'>\r\n" + 
					"            chevron_left\r\n" + 
					"            </span></a>";
		}
		...
		for(int i = 0; i < pageNaviSize; i++) {
			...
			// 다음버튼
			if(pageNo <= totalMan) {
				pageNavi += "<a href='/searchMarketer?reqPage=" + (pageNo) + "'><span class='material-symbols-outlined' style='font-size: 30px;'>\r\n" + 
						"            chevron_right\r\n" + 
						"            </span></a>"; 
			}
	...
	public HashMap<String, Object> searchMember(String type, String keyword, int reqPage) {
		...
		String pageNavi = "";
		if(pageNo != 1) {
			pageNavi += "<a href='/searchMember?reqPage=" + (pageNo - 1) + "'><span class='material-symbols-outlined' style='font-size: 30px;'>\r\n" + 
					"            chevron_left\r\n" + 
					"            </span></a>";
		}
		...
		for(int i = 0; i < pageNaviSize; i++) {
			...
			// 다음버튼
			if(pageNo <= totalMan) {
				pageNavi += "<a href='/searchMember?reqPage=" + (pageNo) + "'><span class='material-symbols-outlined' style='font-size: 30px;'>\r\n" + 
						"            chevron_right\r\n" + 
						"            </span></a>"; 
			}
